...
namespace Server
{
    public static class MondainsLegacy
    {
        ...
        private static readonly Type[] _Artifacts = new Type[]
        {
        ...
        {
            Item item = Activator.CreateInstance(_Artifacts[Utility.Random(_Artifacts.Length)]) as Item;
        ...
        {
            peerlessCorpse.DropItem(Activator.CreateInstance(_Artifacts[Utility.Random(_Artifacts.Length)]) as Item);
        }
