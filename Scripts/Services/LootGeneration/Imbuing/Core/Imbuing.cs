...
namespace Server.SkillHandlers
{
    public class Imbuing
    {
        ...
        {
            for (int index = 0; index < _SpecialImbuable.Length; index++)
            {
                Type i = _SpecialImbuable[index];
        ...
        public static bool NonCraftableImbuable(Item item)
        {
            ...
            for (int index = 0; index < _NonCraftables.Length; index++)
            {
        ...
        public static double GetSuccessChance(Mobile from, Item item, int totalItemIntensity, int propintensity, double bonus)
        {
            ...
            double a = 1554.96118;
            double b = 53.81743328;
            double c = 230.0038452;
            double w = -1664.857794;
        ...
        {
            for (int index = 0; index < m_SkillGroups.Length; index++)
            {
                SkillName[] list = m_SkillGroups[index];
        ...
        {
            for (int index = 0; index < m_CannotImbue.Length; index++)
            {
