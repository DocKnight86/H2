...
namespace Server.Misc
{
    ...
    public class CharacterCreation
    {
        ...
        private static void AddBackpackAndStartingItems(Mobile m)
        {
            ...
            EquipItem(new LongPants(), true);
            EquipItem(new Shoes(), true);
            EquipItem(new SkinningKnife(), true);
        }
        ...
        public static void OnCharacterCreation(CharacterCreationArguments args)
        {
            ...
            AddBackpackAndStartingItems(newChar);
        ...
        private static void SetSkills(Mobile m)
        {
            SkillNameValue[] skills =
            [
                new SkillNameValue(SkillName.Anatomy, 20),
                new SkillNameValue(SkillName.Healing, 20),
                new SkillNameValue(SkillName.Swords, 20),
                new SkillNameValue(SkillName.Tactics, 20),

                new SkillNameValue(SkillName.Tailoring, 20),
                new SkillNameValue(SkillName.Blacksmith, 20)
            ];
